    ...
    <div>
      ...
      {overlayShown &&
        <div className='flex items-center justify-center text-center'>
          ...
          {/* Overlay */}
          <div className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30 rounded-xl bg-white text-brand-dark w-full md:max-w-2xl p-6'>
          ...
          <div className='absolute top-2 right-2 z-30'>
            <svg onClick={() => setOverlayShown(false)} xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 text-white hover:scale-105 transition-all cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
