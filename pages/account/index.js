    ...
    <>
      ...
      <div className="py-12">
        ...
        <div className='flex items-center'>
          ...
          <button onClick={() => setQrRevealed(!qrRevealed)} className='link text-sm ml-8'>
            {qrRevealed ? 'Show NFT' : 'Reveal QR'}
          </button>
