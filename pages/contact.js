  ...
  return (
    <>
      ...
      <div className='pt-12 px-4 md:px-8 lg:w-2/3 lg:mx-auto'>
        ...
        <div className='px-4 pt-8 pb-0 sm:px-12 mt-6 shadow w-full bg-cover bg-no-repeat rounded-lg bg-gray-600/10 backdrop-blur-md text-left'>
          <form onSubmit={submitForm} className='pb-4'>
            ...
            {errorMsg ?
              <div className='text-left bg-brand-dark text-brand block p-4 mt-4'>
                {errorMsg}
              </div>
              :
              sending ?
                <div className='my-8 h-16 mr-16 opacity-60 mb-8 mt-4'>
                  <PacmanLoader color={'var(--color-brand-dark)'} size={30} />
                </div>
                :
